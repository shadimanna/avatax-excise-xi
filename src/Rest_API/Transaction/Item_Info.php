...
class Item_Info extends Base_Info {
	...
	public function convert_data_to_args( $data ) {
		...
		foreach ( $cart_contents as $cart_item ) {
			...
			$item = array(
				...
				'OriginCountryCode'       => $this->api_args['store_address']['country'],
				'OriginCity'              => $this->api_args['store_address']['city'],
				'OriginJurisdiction'      => $this->api_args['store_address']['state'],
				'OriginPostalCode'        => $this->api_args['store_address']['postcode'],
				'SaleCountryCode'         => $this->api_args['sale_address']['country'],
				'SaleCity'                => $this->api_args['sale_address']['city'],
				'SaleJurisdiction'        => $this->api_args['sale_address']['state'],
				'SalePostalCode'          => $this->api_args['sale_address']['postcode'],
			);
	...
	protected function get_transaction_line_schema() {
		return array(
			...
			'OriginCity'              => array(),
			'OriginPostalCode'        => array(),
			'OriginJurisdiction'      => array(),
